...
int main()
{
    ...
    int n,k;//n is the maximum number of elements in the sample space,k is an element in n
    ...
    for(i=1;i<=n;i++)
           ...
           maximum_aANDb=Maximum_aANDb(aANDb,n,k);//to find the maximum number in the array aANDb
           printf("Maximum in A&&B is %d\n",maximum_aANDb);

           maximum_aORb=Maximum_aORb(aORb,n,k);//to find the maximum number in the array aORb
           printf("Maximum in A||B is %d\n",maximum_aORb);


           maximum_aEXORb=Maximum_aEXORb(aEXORb,n,k);//to find the maximum number in the array aEXORb
           printf("MAximum in A^B is %d\n",maximum_aEXORb);
